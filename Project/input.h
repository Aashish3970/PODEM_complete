...
int charToInt(char);
char intToChar(int);
int checkPrimaryOutput(int, GATE*);

int checkDfrontier (GATE* , int, int, int);
nodeValuesFor getObjective( GATE* , LIST* , int , int);

nodeValuesFor Backtrace(nodeValuesFor, GATE*, nodeValuesFor);

int PODEM_recursion(int* , GATE * , int, LIST **, int, int);

int simulatee(int , GATE* ,  nodeValuesFor, int,int , LIST**,int, int);

void printTestPattern(int, GATE*, int, FILE*);
